...
class NewsItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Duration duration = DateTime.now().toUtc().difference(DateTime.parse(news.publishedAt!));
    print(DateTime.now());
    ...
    return InkWell( onTap: (){
      ...
      child: Container(
        child: Column(crossAxisAlignment: CrossAxisAlignment.stretch,
          ...
          Text(news.source!.name!.toUpperCase(), textAlign: TextAlign.start,
          style: const TextStyle(color: Color(0xff79828B),),),
          const SizedBox(height: 5,),
          Text(news.title!, style:
