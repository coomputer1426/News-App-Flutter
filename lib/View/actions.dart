      ...
      children: <Widget>[
        IconButton(padding: EdgeInsets.zero, alignment: Alignment.centerRight,
            ...
            onPressed: ()async{
              ...
              }else {messanger.showSnackBar(const SnackBar(content: Text("No Back History Item"),));}
              return;
            }),
        IconButton(padding: EdgeInsets.zero, alignment: Alignment.centerRight,
          tooltip: "Forward",
          ...
          onPressed: ()async{
            ...
            }else {messanger.showSnackBar(const SnackBar(content: Text("No Forward History Item"),));}
            return;
          },
        ),
        IconButton(padding: EdgeInsets.zero,alignment: Alignment.centerRight,
          icon: Icon(Icons.replay, size: 18,), tooltip: "Reload",
          onPressed: (){
...
class Menu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var newsProvider = Provider.of<NewsChangeNotifier>(context);
    return PopupMenuButton<_MenuOptions>(onSelected: (value)async{
      switch(value) {
        case _MenuOptions.navigationDelegate:
          await newsProvider.controller.loadRequest(Uri.parse("https://youtube.com"));
          break;
        default:
      }
        ...
        itemBuilder: (context)=>[
          const PopupMenuItem( value: _MenuOptions.navigationDelegate,
