...
class CategoryNewsList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<NewsChangeNotifier>(builder: (context, newsprovider, child)=>
      Container(decoration: imageDecoration(),
        child:
        FutureBuilder<SourcesResponse>(
          future: ApiManager.getSources(newsprovider.selectedcategory!.categoryID),
