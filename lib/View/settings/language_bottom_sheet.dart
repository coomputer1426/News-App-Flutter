...
class _LanguageButtomSheetState extends State<LanguageButtomSheet> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            child: Column(
              ...
              children: [
                Consumer<NewsChangeNotifier>(
                  builder: (context, newsproviderConsumer, child) => Container(
                    decoration: BoxDecoration(
                      border: Border.all(width: 2, color: Color(0xff39A552)),
                    ),
                    padding: EdgeInsets.all(2),
                    child: InkWell(
                        onTap: () {
                          newsproviderConsumer.changeLocale("ar");
          ...
          Consumer<NewsChangeNotifier>(
            builder: (context, newsConsumer, child) => Container(
              decoration: BoxDecoration(
                border: Border.all(width: 2, color: Color(0xff39A552)),
              ),
              padding: EdgeInsets.all(2),
              ...
              child: DropdownButton<String>(
                value: newsConsumer.dropdownlan,
                items: newsConsumer.langList
  ...
  Widget getUnselectedItem(String title) {
    return Text(
      title, style: TextStyle(fontSize: 23),
