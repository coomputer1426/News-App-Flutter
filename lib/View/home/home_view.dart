...
import 'package:news_app_route_bloc_clean_arch/View/settings/language_bottom_sheet.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      AppBar(backgroundColor: Colors.green,
        ...
        actions: [Consumer<NewsChangeNotifier>(
      builder: (context, newsproviderConsumer, child) =>
      ...
      drawer: Drawer(
        child: ListView(
          ...
          children: [
            ...
            Consumer<NewsChangeNotifier>(builder: (context, newsconsprovider, child)=>
                ListTile(
              onTap: () {
                newsconsprovider.changeBodyWidgetIndex(0);
                // newsprovider.changeAppBarTitle("6".tr);
                newsprovider.changeAppBarTitle(appBar_Title:AppLocalizations.of(context)!.route_app);
            ...
            Consumer<NewsChangeNotifier>(
              builder:(context, newsconsprovider, child)=> ListTile(
                ...
                onTap: () {
                  ...
                  newsprovider.changeAppBarTitle(appBar_Title:
                      // "Settings"
