...
class CategoryGridView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(onTap: (){onCategorySelected(category, context);},
      child: Container(decoration: BoxDecoration(color: category.categoryBackground,
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,children: [
          Image.asset(category.categoryImage, height: 130,),
          Consumer<NewsChangeNotifier>(builder: (context, newsproviderConsumer, child) {
            ...
            //   else if (index == 0){ newsproviderConsumer.changeCategoryTitle(index, AppLocalizations.of(context)!.politics);}
            return Text(category.categoryTitle, style: Theme
                .of(context)
                .textTheme
                .titleLarge!
