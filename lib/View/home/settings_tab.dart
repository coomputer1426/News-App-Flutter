...
class SettingsTab extends StatelessWidget {
        ...
        Container(padding: EdgeInsets.all(12),
          child: Column(crossAxisAlignment:CrossAxisAlignment.stretch, children: [
            ...
            Padding(
              ...
              child: InkWell(onTap: (){showLanguageBottomSheet();},
                child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(18),
                  ...
                  padding: EdgeInsets.all(12),child:Row(children: [
                    Expanded(
                      child: Text(newsProvider.isEnglish()?
  ...
  void showLanguageBottomSheet() {
    showModalBottomSheet(context: navigatorkey.currentContext!,
